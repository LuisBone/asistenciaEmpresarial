...
class reporteResponsable{

public $codigo;

public function traerReporteResponsable(){
...
$pdf->SetTitle('Reporte por responsable');
...
$html.= '<table>
			<tr style="align:center">
				...
				<td style="width:471px;border: 1px solid #666;text-align:center;"><font size="24">REPORTE DE ACTIVOS</font><br><font size="24">POR RESPONSABLE</font></td>
...
$pdf->Output('reporteResponsable.php');

}

}

$a = new reporteResponsable();
$a -> codigo = $_GET["responsable"];
$a -> traerReporteResponsable();
